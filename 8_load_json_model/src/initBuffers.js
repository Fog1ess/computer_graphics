...
function initBuffers(gl, data) {
    ...
    let integratedData = integrateData(dataFieldNames, attributeDims, data);
 ...
 * @param {modelObj[]} data data array of the models or meshes
 */
function integrateData(dataFieldNames, attributeDims, data, indicesFieldName = "indices") {
    let attributeData = [];
    let elementData = [];
